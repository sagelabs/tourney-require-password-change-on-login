...
from Tourney import config, create_app
from Tourney.utils import string_types

# This is important to allow access to the Tourney application factory
...
if __name__ == "__main__":
    ...
    print(
        ...
        * creating a Tourney export
        * creating a dump of your actual database
        * and backing up the Tourney source code directory"""
    )
    ...
    for unlock in old_data["unlocks"]:
        unlock["user_id"] = unlock.pop(
            "teamid"
        )  # This is intentional as previous Tourneys are effectively in user mode
