#!/usr/bin/env python
# -*- coding: utf-8 -*-
from Tourney.models import Teams, Users
from Tourney.utils import get_config, set_config
from tests.helpers import create_tourney, destroy_tourney, gen_team, login_as_user
...
def test_api_configs_get_non_admin():
    ...
    with app.app_context():
        with app.test_client() as client:
            ...
            assert r.status_code == 403
            assert get_config("ctf_name") == "Tourney"
    destroy_tourney(app)
