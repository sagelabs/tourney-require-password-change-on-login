...
from Tourney import create_app
...
class TourneyTestClient(FlaskClient):
    def open(self, *args, **kwargs):
        ...
        return super(TourneyTestClient, self).open(*args, **kwargs)
...
class ctftime:
    ...
    def init():
        """
        This context manager can be used to setup start and end dates for a test Tourney
        """
        try:
    ...
    def not_started():
        """
        This context manager sets the current time to before the start date of the test Tourney
        """
        try:
    ...
    def started():
        """
        This context manager sets the current time to the start date of the test Tourney
        """
        try:
    ...
    def ended():
        """
        This context manager sets the current time to after the end date of the test Tourney
        """
        try:
...
def create_tourney(
    ...
    app.test_client_class = TourneyTestClient
