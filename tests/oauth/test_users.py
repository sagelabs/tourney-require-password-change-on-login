...
from tests.helpers import create_tourney, destroy_tourney, login_with_mlc, register_user
...
def test_num_users_oauth_limit():
    ...
    app.config.update(
        {
            "OAUTH_CLIENT_ID": "tourney_testing_client_id",
            "OAUTH_CLIENT_SECRET": "tourney_testing_client_secret",
