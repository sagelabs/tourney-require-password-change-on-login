...
from Tourney.plugins.challenges import TourneyStandardChallenge
from Tourney.utils.security.signing import hmac
...
def test_can_update_standard_dynamic_challenge():
    ...
    with app.app_context():
        ...
        challenge = TourneyStandardChallenge.create(req)
        ...
        req = FakeRequest(form=challenge_data)
        challenge = TourneyStandardChallenge.update(challenge, req)
...
def test_can_delete_standard_dynamic_challenge():
    ...
    with app.app_context():
        ...
        challenge = challenges[0]
        TourneyStandardChallenge.delete(challenge)
...
def test_standard_dynamic_challenge_doesnt_lose_value_on_update():
    ...
    with app.app_context():
        ...
        chal = TourneyStandardChallenge.update(chal, req)
...
def test_standard_challenges_default_to_static_function():
    ...
    with app.app_context():
        ...
        # Test with direct model creation (via TourneyStandardChallenge.create)
        challenge_data2 = {
        ...
        challenge2 = TourneyStandardChallenge.create(req)
...
def test_standard_dynamic_challenge_update_overrides_manual_value():
    ...
    with app.app_context():
        ...
        updated_challenge = TourneyStandardChallenge.update(challenge_after_solves, req)
...
def test_standard_dynamic_challenge_creation_requires_all_parameters():
    ...
    app = create_tourney()
    with app.app_context():
        from Tourney.exceptions.challenges import ChallengeCreateException
        ...
        try:
            TourneyStandardChallenge.create(req)
        ...
        static_challenge = TourneyStandardChallenge.create(req)
        ...
        # This should NOT raise an exception
        valid_challenge = TourneyStandardChallenge.create(req)
