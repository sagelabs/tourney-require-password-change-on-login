...
from Tourney.utils.validators import is_safe_url, validate_country_code, validate_email
...
def test_validate_email():
    ...
    assert validate_email("user.io@tourney") is False
    assert validate_email("user\\@tourney") is False
