...
from Tourney.cache import clear_challenges, clear_standings, clear_user_session
...
from Tourney.schemas.awards import AwardSchema
from Tourney.schemas.submissions import SubmissionSchema
from Tourney.schemas.users import UserSchema
from Tourney.utils.challenges import get_submissions_for_user_id_for_challenge_id
from Tourney.utils.config import get_config, get_mail_provider
from Tourney.utils.decorators import admins_only, authed_only, ratelimit
from Tourney.utils.decorators.visibility import (
    check_account_visibility,
    check_score_visibility,
)
from Tourney.utils.email import sendmail, user_created_notification
from Tourney.utils.helpers.models import build_model_filters
from Tourney.utils.security.auth import update_user
...
class UserPublic(Resource):
    ...
    def patch(self, user_id):
        ...
        # https://github.com/Tourney/Tourney/issues/1794
        response = schema.dump(response.data)
        db.session.commit()
        db.session.close()
...
class UserPrivateSubmissions(Resource):
    @authed_only
    def get(self):
        # TODO: Tourney 4.0 Self viewing submissions should not be enabled by default until further notice
