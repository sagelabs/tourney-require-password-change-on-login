...
from Tourney.models import Challenges, Solves, db
from Tourney.utils.decorators import admins_only
from Tourney.utils.modes import get_model
...
class ChallengePropertyCounts(Resource):
    @admins_only
    def get(self, column):
        # TODO: Probably rename this function in Tourney 4.0 as it can be used to do more than just counts now
        funcs = {
            "count": func.count,
            "sum": func.sum,
        }
