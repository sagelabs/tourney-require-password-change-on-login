...
from Tourney.models import Solutions, SolutionUnlocks, db
from Tourney.schemas.solutions import SolutionSchema
from Tourney.utils.challenges import get_solve_ids_for_user_id
