from Tourney.models import Partials
from Tourney.plugins.flags import FlagException, get_flag_class
from Tourney.utils.config import is_teams_mode
from Tourney.utils.user import get_current_team, get_current_user


def challenge_attempt_any(submission, challenge, flags):
    from Tourney.plugins.challenges import ChallengeResponse
