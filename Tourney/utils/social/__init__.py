...
from Tourney.models import Solves, Users
from Tourney.utils import get_config
from Tourney.utils.config import is_teams_mode
from Tourney.utils.formatters import safe_html_format
...
class SolveSocialShare(object):
    ...
    @property
    def content(self):
        from Tourney.utils.challenges import get_solve_counts_for_challenges
