...
from Tourney.cache import cache, clear_user_session
from Tourney.constants.languages import Languages
from Tourney.constants.teams import TeamAttrs
from Tourney.constants.users import UserAttrs
from Tourney.models import Fails, Teams, Tracking, Users, db
...
def get_ip(req=None):
    ...
    Tourney does not use IP address for anything besides cursory tracking of teams and it is ill-advised to do much
...
def get_wrong_submissions_per_minute(account_id, return_objects=False):
    ...
    TODO: Tourney 4.0 Consider removal
