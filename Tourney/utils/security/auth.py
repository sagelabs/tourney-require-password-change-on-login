...
from Tourney.cache import clear_user_session
from Tourney.exceptions import UserNotFoundException, UserTokenExpiredException
from Tourney.models import Users, UserTokens, db
from Tourney.utils import get_app_config
...
def generate_user_token(user, expiration=None, description=None):
    ...
    while temp_token is not None:
        value = "tourney_" + hexencode(os.urandom(32))
