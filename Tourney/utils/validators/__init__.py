...
from Tourney.utils.countries import lookup_country_code
...
def _is_safe_url(target):
    # TODO: Tourney 4.0 In Django this was renamed to `url_has_allowed_host_and_scheme`. Consider similar.
