...
Rewritten version of the Tourney core theme to use Bootstrap 5, Alpine.js, and vite to improve upon the existing Tourney theme structure.
...
```
git subtree add --prefix Tourney/themes/core-beta git@github.com:Tourney/core-beta.git main --squash
```

### Pull latest changes to subtree

```
git subtree pull --prefix Tourney/themes/core-beta git@github.com:Tourney/core-beta.git main --squash
```
...
1. Clone core-beta theme locally to a seperate folder
   ...
   ```
   git clone https://github.com/Tourney/core-beta.git custom-theme
   ```
...
2. Install [Yarn](https://classic.yarnpkg.com/en/) following the [official installation guides](https://classic.yarnpkg.com/en/docs/install).
   ...
   - **[Vite](https://vite.dev/guide/)** handles the frontend tooling in Tourney by building optimized assets that are served through Flask.
...
5. Now, you can start your modifications in the `assets` folder. Each time you save, Vite will automatically recompile everything (assuming you are using `yarn dev`), and you can directly see the result by importing your compiled theme into a Tourney instance.
