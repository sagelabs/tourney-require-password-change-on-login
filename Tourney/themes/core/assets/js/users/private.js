...
Alpine.data("UserGraphs", () => ({
  ...
  async init() {
    this.solves = await Tourney.pages.users.userSolves("me");
    this.fails = await Tourney.pages.users.userFails("me");
    this.awards = await Tourney.pages.users.userAwards("me");
