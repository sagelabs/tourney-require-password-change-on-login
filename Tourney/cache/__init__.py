...
def clear_config():
    from Tourney.utils import _get_config, get_app_config
...
def clear_standings():
    ...
    from Tourney.api.v1.scoreboard import ScoreboardDetail, ScoreboardList
    from Tourney.constants.static import CacheKeys
    from Tourney.models import Teams, Users  # noqa: I001
    from Tourney.utils.scoreboard import get_scoreboard_detail
    from Tourney.utils.scores import get_standings, get_team_standings, get_user_standings
...
def clear_challenges():
    from Tourney.utils.challenges import get_all_challenges  # noqa: I001
...
def clear_ratings():
    from Tourney.utils.challenges import get_rating_average_for_challenge_id

    cache.delete_memoized(get_rating_average_for_challenge_id)


def clear_pages():
    from Tourney.utils.config.pages import get_page, get_pages
...
def clear_user_recent_ips(user_id):
    from Tourney.utils.user import get_user_recent_ips

    cache.delete_memoized(get_user_recent_ips, user_id=user_id)


def clear_user_session(user_id):
    from Tourney.utils.user import (  # noqa: I001
        get_user_attrs,
        get_user_place,
        get_user_recent_ips,
        get_user_schema,
