...
# TODO: Tourney 4.0. These imports previously specified in this file but have moved. We could consider removing these imports
from Tourney.constants.options import (  # noqa: F401
...
class _ConfigsWrapper:
    ...
    @property
    def ctf_name(self):
        return get_config("ctf_name", default="Tourney")
